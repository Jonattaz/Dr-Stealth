...
namespace Mz.App.Procedural
{
    ...
    public partial class MeshDraft
    {
        ...
        /// </summary>
        public static MeshDraft PartialBox(Vector3 width, Vector3 depth, Vector3 height, Direction parts, bool generateUV = true)
        {
            ...
            if (generateUV)
            {
                ...
                if (parts.HasFlag(Direction.Left)) draft.AddQuad(v100, v101, v001, v000, true, uv0, uv1, uv2, uv3);
                if (parts.HasFlag(Direction.Right)) draft.AddQuad(v010, v011, v111, v110, true, uv0, uv1, uv2, uv3);
                if (parts.HasFlag(Direction.Down)) draft.AddQuad(v010, v110, v100, v000, true, uv0, uv1, uv2, uv3);
                if (parts.HasFlag(Direction.Up)) draft.AddQuad(v111, v011, v001, v101, true, uv0, uv1, uv2, uv3);
                if (parts.HasFlag(Direction.Backward)) draft.AddQuad(v000, v001, v011, v010, true, uv0, uv1, uv2, uv3);
                if (parts.HasFlag(Direction.Forward)) draft.AddQuad(v110, v111, v101, v100, true, uv0, uv1, uv2, uv3);
            }
            else
            {
                if (parts.HasFlag(Direction.Left)) draft.AddQuad(v100, v101, v001, v000, true);
                if (parts.HasFlag(Direction.Right)) draft.AddQuad(v010, v011, v111, v110, true);
                if (parts.HasFlag(Direction.Down)) draft.AddQuad(v010, v110, v100, v000, true);
                if (parts.HasFlag(Direction.Up)) draft.AddQuad(v111, v011, v001, v101, true);
                if (parts.HasFlag(Direction.Backward)) draft.AddQuad(v000, v001, v011, v010, true);
                if (parts.HasFlag(Direction.Forward)) draft.AddQuad(v110, v111, v101, v100, true);
            }
            return draft;
        }
    }
