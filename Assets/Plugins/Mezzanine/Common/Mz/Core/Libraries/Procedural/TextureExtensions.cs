...
namespace Mz.App.Procedural
{
    ...
    public static class TextureExtensions
    {
        ...
        /// </summary>
        public static void DrawGradient(this Texture2D texture, Gradient gradient, Direction direction)
        {
        ...
        /// </summary>
        public static void DrawGradient(this Texture2D texture, RectInt rect, Gradient gradient, Direction direction)
        {
        ...
        /// </summary>
        public static void DrawGradient(this Color[] pixels, int textureWidth, int textureHeight, Gradient gradient, Direction direction)
        {
        ...
        /// </summary>
        public static void DrawGradient(this Color[] pixels, int textureWidth, RectInt rect, Gradient gradient, Direction direction)
        {
